  ...
  const searchFilters = () => {
    ...
    if (tempSearchTerm.trim() !== "") {
      filteredData = filteredData.filter((item) => {
        const itemData =
          `${item.razaoSocial} ${item.fantasia} ${item.status} ${item.cpf} ${item.cnpj} ${item.contato}`.toUpperCase();
