...
function CheckList({ types, descricao, placeholderInput, value, readOnly, onChange, menssagemError, inputComponent }) {
  ...
  return (
    <div className="flex items-center"> {/* Removido mb-0 */}
      <label className="block">
        <span className="block text-sm font-medium text-slate-700">{descricao}</span>
