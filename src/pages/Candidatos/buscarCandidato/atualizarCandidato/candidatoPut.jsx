    ...
    useEffect(() => {
        const fetchReceber = async () => {
            try {
                ...
                setObs(data.obs);
                setExpProfissional(data.expProfissional);
            ...
            <form>
                <div className="bg-slate-200 bg-opacity-10 backdrop-filter backdrop-blur-md rounded-lg shadow-xl">
                    <div className="grid grid-cols-1 gap-4 my-2 max-w-full mx-2">
                        <h2 className="text-2xl text-black underline col-start-1 row-start-1">Candidato</h2>
                    </div>
                    <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-4 mt-2 mx-2">
                        ...
                        />
                        <div>
                            <span className="block text-sm font-medium text-slate-700">Categoria:</span>
                            <select
                                id="categoria"
                                value={categoria}
                        ...
                        <div>
                            <span className="block text-sm font-medium text-slate-700">Estado civil:</span>
                            <select
                                id="estadoCivil"
                                value={estCivil}
                            ...
                            >
                                ...
                                <option value="Separado juridicamente">SEPARADO JURIDICAMENTE</option>
                            </select>
                        </div>
                        <CheckList
                            types="tel"
                        ...
                        />
                        <div>
                            <span className="block text-sm font-medium text-slate-700">Departamento:</span>
                            <select
                                id="Departamento"
                                value={departamento}
                    ...
                    <div>
                        <label htmlFor="descricao" className="block text-gray-700 mx-2 mb-8 mt-2 font-medium h-20">
                    ...
                    <div>
                        <label htmlFor="expProfissional" className="block text-gray-700 mx-2 mb-4 font-medium h-20">
                            <span className="block text-sm font-medium text-slate-700">Exp. Profissional:</span>
                            <textarea
                                id="expProfissional"
                                name="profissio"
                    ...
                    <div className="mt-8 mx-2">
                        <h2 className="text-xl mb-2 text-black underline">Histórico de Empresas</h2>
                        ...
                        >
                            <p className="block text-sm font-medium text-slate-100">Adicionar Histórico</p>
                        </button>
                            ...
                            {historico.map((item, index) => (
                                <li key={index} className="flex justify-between border-b py-1">
                                    <span>
                                        ...
                                        {item.dataDemissao ? ` - ${item.dataDemissao}` : ""} {/* Só exibe se houver data */}
                                    </span>
                                    <button
                                        onClick={() => setHistorico(historico.filter((_, i) => i !== index))}
